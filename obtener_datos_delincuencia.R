...
# readr::write_rds(datos_cead, "datos/crudos/cead_crudo_casospoliciales_2024_2.rds", compress = "gz") # actualización de datos 2024 (17 de diciembre 2024, datos nuevos hasta septiembre)
# readr::write_rds(datos_cead, "datos/crudos/cead_crudo_casospoliciales_2018_2024.rds", compress = "gz")
# datos_cead <- readr::read_rds("datos/crudos/cead_crudo_casospoliciales_2014_2024.rds")
